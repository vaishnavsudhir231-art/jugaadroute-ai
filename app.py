...
st.markdown('<p style="text-align: center; color: #10B981; font-weight: 600; letter-spacing: 0.5px;">ZERO-CLICK INSTANT ENGINE (v32.0)</p>', unsafe_allow_html=True)
st.write("---")

# 🔑 अपनी पूरी RapidAPI Key यहाँ उद्धरण चिह्नों (" ") के अंदर एक बार डाल दो भाई!
# इसके बाद बैकग्राउंड में यह अपने आप बिना किसी बटन के सीधे कनेक्ट हो जाएगी।
...
# 🚂 4. Live Instant Processing (No Buttons Needed At All! Updates Dynamically)
...
if src and dest:
    ...
    st.error("❌ Error: Both station names are required to decode the route!")
